import{n as e}from"./roles-Bqq4PLZa.js";var t=e=>window.__remitFault?.(e);function n(){let n=document.getElementById(`popout-root`),r=location.hash.match(/tab=([\w-]+)/)?.[1]??null,i=window.opener,a=i&&i.__remit;if(!a){n.innerHTML=`<div class="popped-placeholder">
      <h2>Disconnected</h2>
...
//# sourceMappingURL=popout-C2KcjyKi.js.map