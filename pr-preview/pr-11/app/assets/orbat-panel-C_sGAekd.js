import{i as e}from"./canonical-DbepWco5.js";import{i as t}from"./hexgrid-Sb_iiCNz.js";import{c as n,d as r,f as i,h as a,i as o,m as s,n as c,o as l,p as u,r as d,s as f,t as p,u as m}from"./orbat-B2z5KKNg.js";var h=`remit:orbat-select`;function g(e){window.dispatchEvent(new CustomEvent(h,{detail:{id:e}}))}var _=[{allegiance:`blue`,title:`Blue (own force)`},{allegiance:`red`,title:`Red (hostile)`},{allegiance:`green`,title:`Green (neutral)`}],v=e=>String(e??``).replace(/[<&"]/g,e=>({"<":`&lt;`,"&":`&amp;`,'"':`&quot;`})[e]??e);function y(h,y){let{objects:b,world:x}=y,S=null,C=e=>e?e.h3?x.ao.idOf.has(e.h3):typeof e.lat==`number`&&typeof e.lng==`number`?t(x.ao,e.lat,e.lng)!==void 0:!1:!1,w=e=>{let t=x.ao,n=(Math.floor(t.N/2)+e*11)%t.N,[r,i]=t.centers[n];return{h3:t.indexes[n],lat:r,lng:i}},T=x.places?.base;i(m(n(),{label:`Own force · ROVER-1`,position:T?{h3:T.h3,lat:T.lat,lng:T.lng}:void 0}));let E=(e,t=null)=>{try{let t=e();return i(t&&t.orbat?t.orbat:t),t}catch(e){return t&&(t.textContent=`⚠ ${e instanceof Error?e.message:String(e)}`,t.classList.add(`orbat-msg-err`)),null}};function D(){let t=n().assets??[];h.innerHTML=`
      ...
      </label>`}function M(e){let t=e.blue?.availability_window;return`
      <label>availability
