...
![Red threat assets placed and tuned on the Solway map](../assets/004-orbat-red-green-assets/hero.png)
...
![The ORBAT authoring panel with the three allegiance groups](../assets/004-orbat-red-green-assets/roster-panel.png)

Two red threat assets placed and tuned (extent + severity) on the Solway map:

![Two red assets with extent rings on the map](../assets/004-orbat-red-green-assets/map-red-assets.png)

Green neutral assets, styled distinctly from red and own force:

![Green neutral assets on the map](../assets/004-orbat-red-green-assets/map-green-assets.png)

A red asset with an active window projects as a Sync-Matrix track, synchronised with the playhead:

![A red asset's active window as a Sync-Matrix track](../assets/004-orbat-red-green-assets/sync-matrix-track.png)
