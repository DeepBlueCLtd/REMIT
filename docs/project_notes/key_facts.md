...
| Data model (LinkML) | **Source of truth:** `schema/remit.linkml.yaml` (DEC-57). Generated, never hand-edited: `schema/gen/remit.schema.json`, `schema/gen/remit.ts`, `site/data-model/index.html`. No Pydantic yet. |
