...
![Seven template capabilities — three already working, four activated in this PR](screenshots/capabilities.svg)
...
![Three-tier active-feature resolution: SPECIFY_FEATURE, then .specify/.active-feature, then the branch token, else a recovery hint](screenshots/resolution.svg)
