...
![Drilling a Plan into its Baseline by clicking a content-id reference, breadcrumb trail above](screenshots/hero.png)
...
![Seven role tabs; Overview is the original UI unchanged](screenshots/tabbar.png)

![The Data Analysis index grouped by object type, with search](screenshots/index.png)

![Popped out: the monitor runs in its own window while the main window returns to the mission](screenshots/popout.png)
